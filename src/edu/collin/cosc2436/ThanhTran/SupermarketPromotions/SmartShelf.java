...
public class SmartShelf<T extends RetailItem> implements IShelfCustomer<T>, IShelfEmployee<T> {
     ...
     */
    @Override
    public void placeItems(List<T> items) {
    	for(T item:items) {
    		this.items.add(item);
    	}
...
//        System.out.println(index);
     ...
     */
    @Override
    public T findAndTake(String itemName, RetailItemType itemType) throws OutOfStockException {
    	RetailItem item = new RetailItem(itemName,itemType);
